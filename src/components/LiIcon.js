...
const LiIcon = ({ reference }) => {
  ...
  return (
    <figure className="absolute -left-9 lg:left-0 stroke-dark dark:stroke-light">
      <svg className="-rotate-90" width="75" height="75" viewBox="0 0 100 100">
        ...
        />
        <circle cx="75" cy="50" r="20" className="animate-pulse stroke-1 fill-primary dark:fill-primaryDark"></circle>
      </svg>
    </figure>
  );
};
